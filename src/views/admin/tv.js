...
export default function Tv() {
    ...
    const handleSubmit  = async () =>  {
        ...
        try {
            Swal.fire({
                title: 'Are you sure?',
                text: 'Do you want to subscribe ' + document.getElementById("productid").options[document.getElementById("productid").selectedIndex].text + ' on ' + document.getElementById("number").value + '?',
                icon: 'warning',
